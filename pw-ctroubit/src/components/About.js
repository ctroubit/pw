    ...
    <div className="part1-container">
        ...
        <div className={`text ${theme}-theme`}>
            <p>
                ...
                software engineering student at Western University. I chose to
                go into software after my second year because I found programming
                to be very fun and rewarding. It wasn't my initial plan, but I'm
                glad I did because the possibilities of what you can create are endless.
                I'm always thinking of how we can take software to the next level.
            </p>
            <p>
                Some of my hobbies are music, playing guitar, and going to the gym. Music
                in particular is one of my favourite passions, hence why I designed this
                website to mimic Spotify (My dream company) and Apple Music's design palettes.
                You can choose which theme you like best (although Spotify is the better streaming service).
            </p>
        </div>
    </div>
    <div className="part2">
        ...
        <div className={`text2 ${theme}-theme`}>
            <p>
            ...
            <p>
                ...
                contributed immensely to my work ethic and make me the person who I am
                today. I've also met a lot of amazing people along the way, and I would not
                be where I am now without them.
            </p>
        </div>
    </div>
    <div className={`text3 ${theme}-theme`}>
        <p>
            I'll be adding more to this, but I hope this is a good enough picture into my
            life, passions, and work experience.
        </p>
